...
export function ReportScreen({
  ...
  const handleSubmitReport = async () => {
    ...
    const storageBucket = 'reports_media';
    ...
    try {
      ...
      let targetReportTable = 'reports_unconfirmed';
      if (userId) {
  ...
  return (
    <>
<div className="min-h-screen w-full bg-gradient-to-br from-blue-50 to-indigo-100 overflow-y-auto">
